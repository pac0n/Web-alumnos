...
if(!isset($_SESSION["matricula"]))
{
  ...
  $cursos_alumno="SELECT *  FROM curso_alumno WHERE matricula='$matriculaLog'";
  $resultado=$mysqli->query($cursos_alumno);
?>
<html>
<head>
  <meta charset="utf-8">
    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>
<?php
    echo'<center>   <b><font color="#000000" face="georgia" size="4"><marquee width="200" scrollamount="6" bgcolor="#FFFFFF">Bienvenido(a) '.$nombreu.'</marquee></font>';
?>
</p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <br><br>			
		...
		<br><br><br><br>
		<div class="box-body">
		<form action="agregar_c.php" role="form" method="post">
			<label for="full-names"><b>Contraseña: </b></label>
            <input type="text" placeholder="Ingresa token del curso" name="contra" required>
            <input type="hidden" name="matricula" value="<?php echo $matriculaLog;?>" required>
            <button type="submit" class="login-button">Agregar curso</button>
		</form>
            <br><br><br>
            <div class="box-body">
